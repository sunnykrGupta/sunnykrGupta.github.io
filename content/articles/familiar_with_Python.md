...
- Learn about [REST architecture](http://en.wikipedia.org/wiki/REST).
...
>[2.1]: [Python Style Guide](http://www.python.org/dev/peps/pep-0008).
...
>[8]: [Two scoops for Django Book](http://bit.ly/16z2gQq)

>[9]: [Pro python Book](http://bit.ly/197rnvU)
